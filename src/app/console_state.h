...
struct console_persistent_state {
    ...
    console_tab active_tab{console_tab::graphic_eq};
};
...
public:
    ...
    [[nodiscard]] console_tab active_tab() const noexcept;
    ...
    void set_active_tab(console_tab tab) noexcept;
...
private:
    ...
    console_tab active_tab_{console_tab::graphic_eq};
};
