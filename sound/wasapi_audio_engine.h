...
private:
    ...
    std::array<std::atomic<std::uint32_t>, arbitrary_band_count> arbitrary_frequency_bits_{};
    std::array<std::atomic<std::uint32_t>, arbitrary_band_count> arbitrary_gain_bits_{};
    std::array<std::atomic<std::uint32_t>, arbitrary_band_count> arbitrary_q_bits_{};
    std::array<std::atomic<bool>, arbitrary_band_count> arbitrary_enabled_{};
    std::atomic<std::uint8_t> processing_mode_{};
